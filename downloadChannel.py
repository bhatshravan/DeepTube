        ...
        for video in video_id:
            try:
                ...
                if(not videoPaf=="Error"):
                    videoMeta = [str(channel_id),str(video[0]),videoPaf.title.replace(",","---"),str(videoPaf.author),str(videoPaf.duration),str(videoPaf.likes),str(videoPaf.dislikes),str(videoPaf.viewcount),str(videoPaf.thumb),video[1]]
